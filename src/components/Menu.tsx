...
function Menu() {
  ...
  return (
    <div className="flex items-center space-x-2 py-1 px-4 hover:bg-hoverColor rounded-full cursor-pointer" onClick={() => navigate("application")}>
      <svg
      ...
      <span className="hidden font-bold text-sm sm:block">Application</span>
    </div>
  );
}
